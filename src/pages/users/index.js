...
import {GET_ALL_USERS} from '../../routes/auth.js';
import {USERS_FETCHED_SUCCESS_MESSAGE} from '../../messages/message.js';
...
export default function EnhancedTable({token}) {
  ...
  return (
    <>
      <DeleteUser currentModalState={deleteModalState} updateParentDeleteModalState={handleDeleteModalState} userId={userId} deleteUser={deleteUser} />
      <Box sx={{ flexGrow: 1 }}>
      ...
      <Box sx={{flexGrow: 1, marginLeft: "auto" }} mt={4} mb={4} >
        <CreateUserForm addUser={addMoreUser}/>
      </Box>
